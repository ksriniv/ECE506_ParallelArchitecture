...
public:
   cache_line()							{ tag = 0; State = I; seq = 0; }
...
protected:
	...
	ulong I2E, I2S, M2S, E2S, S2M, I2M, E2M, dir_S2EM, dir_EM2S;
...
//	ulong bus_reads, bus_readxs, bus_updates, bus_upgrades;
	...
	ulong get_dir_S2EM()		{return dir_S2EM;}
	ulong get_dir_EM2S()		{return dir_EM2S;}
...
public:
	...
	static Cache* create_cache(int protocol_no, int size, int assoc,
			int block_size, int num_processor, ulong directory_size,
			int processor_num);
};
