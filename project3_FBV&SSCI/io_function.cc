...
void print_sim_stats(int cache_size, int cache_assoc, int blk_size,
		int num_processors, const char **protocol_names, int protocol,
		char *fname, int dir_type) {
	printf("===== FA16 506 BUS BASED CACHE Configuration =====\n");
...
//
void print_sim_results(int num_processors, Cache** processor_cache,
