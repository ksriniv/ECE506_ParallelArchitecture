...
int main(int argc, char *argv[]) {
	...
	print_sim_stats(cache_size, cache_assoc, blk_size, num_processors,
			protocol_names, protocol, fname, dir_type);

	//*******Create an array of caches here*********//
	ulong dir_size = (cache_size * num_processors) / blk_size;
	create_processor_cache(num_processors, cache_size, cache_assoc, blk_size,
			protocol, dir_size, dir_type);
